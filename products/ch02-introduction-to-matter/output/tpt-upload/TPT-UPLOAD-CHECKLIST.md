# TPT Upload Checklist — CN-CH02-MATTER
...
- [x] `CurioNest_CH02_Introduction_to_Matter_Complete.pdf` — 51 pages
- [x] `CurioNest_CH02_Introduction_to_Matter_Lesson_Slides.pdf` — 15 pages
- [x] `CurioNest_CH02_Introduction_to_Matter_Student_Guided_Notes_and_Practice.pdf` — 12 pages
- [x] `CurioNest_CH02_Introduction_to_Matter_Unit_Test_A.pdf` — 4 pages
- [x] `CurioNest_CH02_Introduction_to_Matter_Unit_Test_B.pdf` — 4 pages
- [x] `CurioNest_CH02_Introduction_to_Matter_Teacher_Guide_and_Answer_Key.pdf` — 13 pages
- [x] `CurioNest_CH02_Introduction_to_Matter_Rights_and_Sources.pdf` — 2 pages
...
- [ ] U.S. chemistry/science teacher independently solves every scored item and checks every answer, rationale, calculation, classification, grade fit, and standards statement.
...
- [x] Every instructional visual matches `assets/manifest.json`; creator, license, URL, use, access date, and retained evidence are recorded.
